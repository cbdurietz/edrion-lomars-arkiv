...
**Karaktär:** Gammalt, stolt, medvetet om sin roll som levande monument. Rör sig sakta och med värdighet. Familjen är inte dum — de vet precis vad de är och vad de inte längre är. De hanterar sin symboliska makt med kirurgisk precision och slösar den aldrig.

**Spänningar:**
- Mot *Kael*: Betraktar dem som ett störningsmoment i en ordning som fungerat i sekler.
- Mot *Avel*: En underliggande övertygelse om att Meridia är meridiskas och att resten är gäster.
...
**Rådsrelation:** Direkt säte, formellt som "militär befälhavare", reellt som sig själva. En av de två familjer som öppet sitter i rådet som familj snarare än som representant för något annat.

**Karaktär:** Pragmatiska och disciplinerade. Ser sig som stadsstatens egentliga ryggrad — utan dem är Meridia bara en klippa med goda bibliotek. Sällan eleganta i politiken men sällan överraskade heller. Vaen planerar i decennier.
...
**Rådsrelation:** Sitter i rådet som akademirepresentant för Kartografiska Kollegiet. Alla vet att det är Thalis som sitter, inte kollegiet — men distinktionen upprätthålls av formens skull.

**Karaktär:** Intellektuell och lätt aristokratisk. Mån om att framstå som lärda snarare än handelsmän, en distinktion som är hårfinare än Thalis vill medge. Behandlar kunskap som egendom och forskning som investering.
...
- Mot *Avel*: Stilla misstänksamhet mot den östliga handelsfamiljen som ibland verkar ha kartor Thalis inte gjort.
...
Lagerhus, kajer, kranar, tullvägningshus, skeppsvarv. Orren äger den fysiska infrastruktur som gör Meridia till en omlastningshamn snarare än en fästningsö. Utan Orren kan fartygen inte lasta om; utan omlastningen är passagekontrollen värdelös. Det gör dem på ett ganska obehagligt sätt till den familj som ingen kan undvara.

De är enormt rika och fullständigt ointresserade av vad folk tycker om dem.

**Rådsrelation:** Sitter som hamngillets representant. Hamngillen är till stor del deras skapelse och finansieras av deras kapital. Formellt en gillesröst; reellt en familjeröst.

**Karaktär:** Korta meningar, långa minnen. Orren räknar allt i last och vinst. Varken akademisk bildning eller militär pondus — de har aldrig behövt det. Arbetar gärna med vem som helst om siffrorna stämmer.

**Spänningar:**
- Mot *Vaen*: Se ovan. En strukturell konflikt inbygd i stadsstatens ekonomi.
- Med *Avel*: Naturliga allierade. Gemensam handelspragmatism utan sentimentalitet.
...
**Rådsrelation:** Inget direkt säte, och de vill inte ha det. Ett säte kräver att man väljer sida. Cassel väljer aldrig sida officiellt.

**Karaktär:** Ytterst artiga, ytterst tålmodiga, ytterst ointresserade av att verka mäktiga. De kallar sig bankirer, aldrig makthavare — och det stämmer, nästan. Deras makt är inte att befalla utan att avvakta.
...
Avel anlände till Meridia för tre eller fyra generationer sedan, ursprungligen från Serthara eller möjligen längre österut — källorna är inte eniga. De etablerade sig snabbt tack vare handelsnätverk österut som ingen meridisk familj hade: agenter och kontakter i hamnar dit meridianska fartyg sällan räcker på egen hand. Deras gods rör sig längs rutter som inte syns på Thalis kartor.

De är nu djupt rotade i Meridia men bär fortfarande på stämpeln av att ha kommit utifrån.

**Rådsrelation:** Inget direkt säte. Arbetar via Orren i rådet och via Sorne — vars skulder de i tysthet förvaltar — för att säkra röster när det behövs.

**Karaktär:** Kosmopolitiska, anpassningsbara, medvetna om att de aldrig helt accepterats av de äldsta familjerna och länge sedan slutat bry sig om det. Kompenserar med resultat.
...
**Rådsrelation:** Håller ett gammalt och tekniskt sett legitimt säte, men deras röst har i praktiken köpts av dem som finansierar deras verksamhet — för tillfället Huset Avel, som håller deras skulder och ber om lite vänlighet i gengäld.
...
Astrolaber, kompasser, sextanter, graderade mätcylindrar. Varje Navigationsskolans utbildad lots bär Kael-märkta instrument. Tillverkningen är industriell till sin skala och exporten täcker hela Prima — ett meridianskt instrument är ett Kael-instrument, på väg att bli lika självklart som en meridiansk karta. Familjen finansierar Navigationsskolan aggressivt, dels av genuint intresse, dels för att varje utexaminerad lots är en framtida kund.

**Rådsrelation:** Inget säte, och det är deras tydligaste politiska mål. De knackar på dörren med allt mer kapital bakom sig.

**Karaktär:** Ambitiösa, pragmatiska, lätt rastlösa. Ser Meridias gamla strukturer som hinder att kringgå snarare än traditioner att respektera. Förstår inte varför ålder i sig ska vara ett argument — eller låtsas inte förstå det.
...
| Infödd vs. utländsk | Merid, Thalis ↔ Avel |
| Fallande vs. stigande | Sorne ↔ Kael |
| Öppen makt vs. skuggmakt | Vaen, Merid ↔ Cassel, Avel |
...
Utanför protokollet: Cassel håller skuldeboken över halva rummet, och Avel vet vilka rutter Thalis kartor inte visar.
