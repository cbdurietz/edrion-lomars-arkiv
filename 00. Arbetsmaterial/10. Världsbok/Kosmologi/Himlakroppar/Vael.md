...
| Parameter | Värde |
|---|---|
| Massa | 0,0186 jordmassor (~1,5× Jordens måne) |
| Radie | ~2 000 km (~15% större än Jordens måne) |
...
Vaels omloppsperiod på ~30 dagar ligger till grund för tidsenheten **vaelar**. Hur vaelarna strukturerar kalenderåret – inklusive överskottsdagen och femdagarscyklerna – beskrivs i [[Tideräkning|Tideräkning på Prima]].

Faserna följer en regelbunden cykel:

| Dag | Fas |
|---|---|
| 1 | Nymåne (mörk himmel) |
| ~5 | Tilltagande skära |
| ~8 | Första kvarten (halvmåne) |
| ~11 | Tilltagande, nästan full |
| 15–16 | Fullmåne (vaelarens höjdpunkt) |
| ~20 | Avtagande halvmåne |
| ~25 | Avtagande skära |
